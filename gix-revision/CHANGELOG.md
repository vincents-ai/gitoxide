 ...
 * **Uncategorized**
    ...
    - Adopt to changes related to the introduction of `nonempty`. ([`e033441`](https://github.com/GitoxideLabs/gitoxide/commit/e033441c72ad4afe07ad67d4e3ba3176287829b4))
...
<csr-id-829393ac596bf2684bd8a837ae931773b24ee033/>

### New Features (BREAKING)

 - <csr-id-6b1145ddb7d06fdcc23711876af9d25e80e82da8/> Convert `gix-revision` to use `gix-error`
 ...
 * **Uncategorized**
    ...
    - Convert `gix-revision` to use `gix-error` ([`6b1145d`](https://github.com/GitoxideLabs/gitoxide/commit/6b1145ddb7d06fdcc23711876af9d25e80e82da8))
...
### New Features
 ...
 - <csr-id-0d64f3a0ae2f5da3a6a5bf63afe1cce3acc5b07e/> add `merge_base::octopus()`.
...
### New Features
 ...
 - <csr-id-cf833491da2a6b8d216805f6f9a804c1d4086cea/> first basic implementation of `merge_base()`.
 - <csr-id-87c98cde68010a497dbcdf34a39e14181f4ce3dd/> add `Graph::insert_commit()` to easily set flags and get a callback with looked up commit data.
...
<csr-id-287455f60f198b29997960897b411665b5e47f06/>

### Other

 - <csr-id-287455f60f198b29997960897b411665b5e47f06/> gate few deps unsed describe feature
...
### Bug Fixes
 ...
 - <csr-id-9b1a57574bab0639d3c38be2001f545a6c8e0333/> prevent underflows while trying to `abs()` very large numbers.
 ...
 * **[#427](https://github.com/GitoxideLabs/gitoxide/issues/427)**
    ...
    - Support for `<rev>^-<n>` and `<rev>^-` ([`fa1615d`](https://github.com/GitoxideLabs/gitoxide/commit/fa1615da63594acbe92c3c4a13e2aeb7c1ee1d94))
    ...
    - Implement :<path> parsing ([`74e7a46`](https://github.com/GitoxideLabs/gitoxide/commit/74e7a46199d3ae13d8bc3616d285c238942c2cad))
