...
### Bug Fixes
 ...
 - <csr-id-1c1ffdf19e505a6e29d98df28b9309eace15688f/> change RefSpecRef::prefix behaviour
 ...
 * **Uncategorized**
    ...
    - Refactor ([`de8dd0b`](https://github.com/GitoxideLabs/gitoxide/commit/de8dd0b44375d7b747c03ddc7d547cbf4b4e3f38))
    - Change RefSpecRef::prefix behaviour ([`1c1ffdf`](https://github.com/GitoxideLabs/gitoxide/commit/1c1ffdf19e505a6e29d98df28b9309eace15688f))
    ...
    - Address Codex review ([`0e07715`](https://github.com/GitoxideLabs/gitoxide/commit/0e07715aa9ee035887ced3e4b81ba82982343620))
    - Use `GIX_TEST_FIXTURE_HASH` for `gix-refspec` ([`7a14783`](https://github.com/GitoxideLabs/gitoxide/commit/7a14783d3db389551d85eb1d40da835fdec33eff))
 ...
 * **Uncategorized**
    ...
    - Implement Needle::Pattern for full glob support in one-sided refspecs ([`d6835f2`](https://github.com/GitoxideLabs/gitoxide/commit/d6835f25374d17e940017359f41b3cce2ff1ea20))
    - Add a way to match refspecs with full globs support ([`1bccc54`](https://github.com/GitoxideLabs/gitoxide/commit/1bccc54111f9cd888c4f8d42ba6b9b5e3a5e9994))
    - Refactor ([`0d5372d`](https://github.com/GitoxideLabs/gitoxide/commit/0d5372d30bf58583419b8467ed5f3e2c5a6f16c7))
    - Cargo fmt ([`bb84248`](https://github.com/GitoxideLabs/gitoxide/commit/bb84248d3515565b936f2cfb71a4bc79e4563a62))
    - Allow complex glob patterns in one-sided refspecs ([`d79f896`](https://github.com/GitoxideLabs/gitoxide/commit/d79f896f48449af90efcc84da58418194cb31bff))
...
### Bug Fixes
 ...
 - <csr-id-9cebccf79b6622a078079c2c5b4d82e7b9151aee/> Allow negative refspecs when pushing
   This effectively reverts 9c280b2de59773c6d13134e3257cf1da5731e35d
 ...
 * **Uncategorized**
    ...
    - Allow negative refspecs when pushing ([`9cebccf`](https://github.com/GitoxideLabs/gitoxide/commit/9cebccf79b6622a078079c2c5b4d82e7b9151aee))
...
### New Features (BREAKING)
 ...
 - <csr-id-aa56128a79b43033b3a366e3783b2c11880e3384/> Add reverse-mapping via `MatchGroup::match_rhs()`.
...
### New Features
 ...
 - <csr-id-8dd76e3b6eb5910f0b54def26d3d31e15626b327/> Add `MatchGroup::from_push_specs()` for symmetry with `*::from_fetch_specs()`
 ...
 * **Uncategorized**
    ...
    - Add `MatchGroup::from_push_specs()` for symmetry with `*::from_fetch_specs()` ([`8dd76e3`](https://github.com/GitoxideLabs/gitoxide/commit/8dd76e3b6eb5910f0b54def26d3d31e15626b327))
    - Improve docs slightly ([`3e13152`](https://github.com/GitoxideLabs/gitoxide/commit/3e13152991148ff9a6fca65388e1414d624b21e4))
 ...
 * **Uncategorized**
    ...
    - Refactor ([`374dee6`](https://github.com/GitoxideLabs/gitoxide/commit/374dee66b5023ee94db9b332b511e1b6943b51b0))
 ...
 * **Uncategorized**
    ...
    - Improve ref-spec docs of the allowed types of fetch specs, source side. ([`2800600`](https://github.com/GitoxideLabs/gitoxide/commit/2800600ca0ce0f4ccfc9d76b495f83483f38322e))
</details>
 ...
 * **Uncategorized**
    ...
    - Add clusterfuzz failure which doesn't actually reproduce. ([`386876f`](https://github.com/GitoxideLabs/gitoxide/commit/386876fc541be56d1d7173a58ed6c13564f93c64))
</details>
...
<csr-read-only-do-not-edit/>
 ...
 - 5 unique issues were worked on: [#450](https://github.com/GitoxideLabs/gitoxide/issues/450), [#470](https://github.com/GitoxideLabs/gitoxide/issues/470), [#571](https://github.com/GitoxideLabs/gitoxide/issues/571), [#691](https://github.com/GitoxideLabs/gitoxide/issues/691), [#XXX](https://github.com/GitoxideLabs/gitoxide/issues/XXX)
 ...
 * **[#450](https://github.com/GitoxideLabs/gitoxide/issues/450)**
    - Improve docs for `Instruction` ([`911f68f`](https://github.com/GitoxideLabs/gitoxide/commit/911f68fe099e3eac7dd4a0f15fcd682657564389))
    - `HEAD` may now return itself as prefix in `RefSpecRef::prefix()` and `expanded_prefix()`. ([`d53ddcd`](https://github.com/GitoxideLabs/gitoxide/commit/d53ddcde948cfbd7773eb830cbb636626b32debb))
    - Fix docs ([`9d0f31e`](https://github.com/GitoxideLabs/gitoxide/commit/9d0f31e4bea4b47f1a91fa4dc38f592bdbf976a8))
    - Add `RefSpecRef::expand_prefix()` method to avoid missing prefixes. ([`21b21b6`](https://github.com/GitoxideLabs/gitoxide/commit/21b21b6c25e1d8d1da9464b7bef06a795f679210))
    - `RefSpec::allow_non_fast_forward()` to get information about 'force' quickly. ([`d7f63a6`](https://github.com/GitoxideLabs/gitoxide/commit/d7f63a6c60a826dc862bd13adbef041e4ac6d8ab))
    - `RefSpecRef` instruction uses the correct lifetime. ([`278ff7a`](https://github.com/GitoxideLabs/gitoxide/commit/278ff7a6ee084ea864193a5ca25b6cd0f18e19a0))
    - A more efficient representation for `validate::Fix` ([`e819fc6`](https://github.com/GitoxideLabs/gitoxide/commit/e819fc68531e2d2de3d7df782f63f84941eeef57))
    - Make `specs` in `MatchGroup` public to reduce API surface. ([`2a7df32`](https://github.com/GitoxideLabs/gitoxide/commit/2a7df323b15678aee3e61a41908aceb644873b11))
    - Allow `match_group::Fix` to be cloned. ([`85c49ec`](https://github.com/GitoxideLabs/gitoxide/commit/85c49ec16ac7eeb2175fa43545c72b81da693ab1))
    - Fix `match_group::Item` to make it uniform with how we typically name refs ([`21420da`](https://github.com/GitoxideLabs/gitoxide/commit/21420dacb485795e80baabf2a300ff900036ba7b))
    - Remote todo with note about our current understanding ([`9dc7a3f`](https://github.com/GitoxideLabs/gitoxide/commit/9dc7a3f40dbf3d4802ed095fc21dfb3da67acfea))
    - Actually assure we don't try to write into the HEAD ref, which git avoids as well ([`1335618`](https://github.com/GitoxideLabs/gitoxide/commit/13356184c735d72edb891d64b3de1bb5c981a6ad))
    - Allow 'HEAD' based refspecs to match correctly ([`7432a2b`](https://github.com/GitoxideLabs/gitoxide/commit/7432a2bb5d11e9991ed5f9d1b29ecf79b10c676a))
    - Tests to show that empty remotes actually work ([`2fdec73`](https://github.com/GitoxideLabs/gitoxide/commit/2fdec7315a65117095f909b4d7d57a91ba666a43))
    - Another test which doesn't manage to trigger a certain message from git. ([`4f48095`](https://github.com/GitoxideLabs/gitoxide/commit/4f48095566fc1e2b440d542ef2c5118c3e37fddd))
    - Fully drop 'funny' names ([`f137d60`](https://github.com/GitoxideLabs/gitoxide/commit/f137d6010610d98de32edb4501053d7786181217))
    - A first version of the 'funny name' sanitization ([`c81e418`](https://github.com/GitoxideLabs/gitoxide/commit/c81e418ae7f90b674ad005e4b42816c35332a417))
    - Frame for testing of fixes ([`9148102`](https://github.com/GitoxideLabs/gitoxide/commit/91481020c87cfa0cae9dd497fb87e7fb9dd33c8a))
    - Refactor ([`d37fd04`](https://github.com/GitoxideLabs/gitoxide/commit/d37fd044df2cc5355735121e63fcc3c54b8ea4cb))
    - All baseline specs are tested and pass ([`afc0a3d`](https://github.com/GitoxideLabs/gitoxide/commit/afc0a3da864362ec7a0ab243f72daba4713db569))
    - The first test to validate conflict reporting ([`aef0a46`](https://github.com/GitoxideLabs/gitoxide/commit/aef0a464811ce98e81d44d1417098c9adef035f5))
    - Sketch of validation API along with test suite integration ([`70a765e`](https://github.com/GitoxideLabs/gitoxide/commit/70a765e295295f87f8550453452d2ffe95b177be))
    - Refactor ([`547129e`](https://github.com/GitoxideLabs/gitoxide/commit/547129e98dfcac32ebc83e743f9aee05d038629b))
    - Sketch `Outcome` type which can be used for later sanitization and validation. ([`53e17c1`](https://github.com/GitoxideLabs/gitoxide/commit/53e17c10f663bc3c389a13cdfec3716da34dd311))
    - Prepare first test for conflicts and validation ([`508a33a`](https://github.com/GitoxideLabs/gitoxide/commit/508a33a5f279c9a6f29e98f560fcd54cea1ed77d))
    - Just-in-time deduplication of mappings ([`8ed5d01`](https://github.com/GitoxideLabs/gitoxide/commit/8ed5d01a75ceb03083b2bddc58b1e9dc26a66cd0))
    - Adjust expectations to make first exclusion tests work ([`6e1b19b`](https://github.com/GitoxideLabs/gitoxide/commit/6e1b19b7f07050c3fcb70187a4d6a4e4210d3343))
    - Reject all invalid negative refspec patterns. ([`4c4f821`](https://github.com/GitoxideLabs/gitoxide/commit/4c4f82170d08b910a7f64482431c99956b1a04c3))
    - Basic negation implementation along with first failure. ([`e4931d0`](https://github.com/GitoxideLabs/gitoxide/commit/e4931d0205c9b8e8e859e8ea940b67483e62a07e))
    - First tests for multiple refspecs ([`77db112`](https://github.com/GitoxideLabs/gitoxide/commit/77db1127a8ccd71c75670b5d803cabcf93cbcedc))
    - Refactor ([`4c73a19`](https://github.com/GitoxideLabs/gitoxide/commit/4c73a19ae4b044df816e95a4fc19dc6481222a4c))
    - Refactor ([`00401be`](https://github.com/GitoxideLabs/gitoxide/commit/00401bef4279d4b8152ea4c149a00ddf50f518e3))
    - Improved glob matching ([`eaf36e7`](https://github.com/GitoxideLabs/gitoxide/commit/eaf36e7d0336be8398d0b1d9414d3ad73afbb393))
    - Basic glob matching. ([`a93628c`](https://github.com/GitoxideLabs/gitoxide/commit/a93628cb404987c498779b35994db0a05b3dbc0a))
    - Type-system supprots  glob matching ([`4b73d11`](https://github.com/GitoxideLabs/gitoxide/commit/4b73d11a4f0bef8db374cde567547a9ba7097719))
    - More tests for simple 1:1 fetch and update specs ([`74de83c`](https://github.com/GitoxideLabs/gitoxide/commit/74de83cbea30b84136bfa191f471e137ae7af5c3))
    - Make it easy to obtain the local and remote sides of RefSpecs ([`67506b1`](https://github.com/GitoxideLabs/gitoxide/commit/67506b1b1997c2b5951f0e1320b0459eac1366e2))
    - Don't reject object-id like heads on the receiving side. ([`6668c3f`](https://github.com/GitoxideLabs/gitoxide/commit/6668c3f418663ed6f2ed56efd3d7e78d27124296))
    - Make object-ids in the source position type-safe ([`413051d`](https://github.com/GitoxideLabs/gitoxide/commit/413051d03c843c9c99dbc67f4a5f48d6f2b1aeb2))
    - Prepare for dual-sided ref mapping to realize that it needs a special case. ([`7368fe4`](https://github.com/GitoxideLabs/gitoxide/commit/7368fe4ee38bbd34bd811310afa8eeb78c475fda))
    - Refactor ([`579e891`](https://github.com/GitoxideLabs/gitoxide/commit/579e89188679942508f9da107d856ab782a512a1))
    - Support testing source-only object names ([`bb61c49`](https://github.com/GitoxideLabs/gitoxide/commit/bb61c49a9b6a3a109d7af3ddde43fc98bb712ec7))
    - Preliminary matching of refs by name ([`426107f`](https://github.com/GitoxideLabs/gitoxide/commit/426107fea911a2f75d3b624a1c7279cac4edc12e))
    - Handle partial names as well ([`dc7f162`](https://github.com/GitoxideLabs/gitoxide/commit/dc7f1620cb6d00af60cf78e02b4c2949a3e260e4))
    - Generalize baseline assertion to support multiple input specs ([`b752e48`](https://github.com/GitoxideLabs/gitoxide/commit/b752e48b4201c1f26401af39de0a7312b158607b))
    - First successful test ([`3625d5a`](https://github.com/GitoxideLabs/gitoxide/commit/3625d5a0abb109270b046e2dc206d6f870164306))
    - Top-level match-group loop without negation ([`c915a5f`](https://github.com/GitoxideLabs/gitoxide/commit/c915a5f5f0d771e704b108b9442a605d62f0945e))
    - Refactor to use a match-group instead. ([`4ba31c5`](https://github.com/GitoxideLabs/gitoxide/commit/4ba31c55b57f644361e18e5d31d5df514cddd58a))
    - Not using a matchgroup right away seems like the wrong approach ([`7f3bc30`](https://github.com/GitoxideLabs/gitoxide/commit/7f3bc300dfb980d6e6aa72f8c22edd58fa9351fb))
    - Actual expectation for first simple test ([`cec6905`](https://github.com/GitoxideLabs/gitoxide/commit/cec69057585796ec7bc69f5a6295b97cddb8cb4f))
    - Get to the point where the matcher is invoked ([`cbbdf59`](https://github.com/GitoxideLabs/gitoxide/commit/cbbdf59290d6c3fb4936b31e3b7836becb126ce4))
    - Simple serialization for `Instruction` and `RefSpecRef` type. ([`abdf83f`](https://github.com/GitoxideLabs/gitoxide/commit/abdf83f494e2a9fba4a8d9fcb776f2c84baebd3e))
    - Ground work for matcher tests ([`509764c`](https://github.com/GitoxideLabs/gitoxide/commit/509764c95978115da129b8bb9baeb304634fa10c))
    - Tag specific tests ([`4f35485`](https://github.com/GitoxideLabs/gitoxide/commit/4f354852e15b469260bd3553e4f615f9612fabcc))
    - More tests to investigate conflict handling ([`192d4f7`](https://github.com/GitoxideLabs/gitoxide/commit/192d4f78ba611f090dafda7ef5014efb900d2115))
    - A more realistic sketch for `Matcher`, which will need a surrounding `MatchGroup` ([`dd1d824`](https://github.com/GitoxideLabs/gitoxide/commit/dd1d8244c8708bbc3583cc0f3f42ad967d5ad524))
    - More robust baseline tests on windows ([`54ca267`](https://github.com/GitoxideLabs/gitoxide/commit/54ca267138a5116aa2215109b4abe00a64518feb))
    - Pares FETCH_HEAD (as specs without local sides); sketch `Match` type ([`44228a0`](https://github.com/GitoxideLabs/gitoxide/commit/44228a0b9c057bcc915bc0ade43b4ccb3cb916f2))
    - Restore full ref names for baseline ([`f6124db`](https://github.com/GitoxideLabs/gitoxide/commit/f6124db39dc0e828801a59310265d95a755ea46a))
    - Parse basline mapping ([`3000a14`](https://github.com/GitoxideLabs/gitoxide/commit/3000a14c1eed4a543fdef2fd8bcbacba2742aece))
    - Parse baseline reflist which serves as input to the matcher ([`fce877f`](https://github.com/GitoxideLabs/gitoxide/commit/fce877f8d2112fafdb71208784104a66b2313a40))
    ...
    - Prefer to represent instructions with Matchers ([`0887e2e`](https://github.com/GitoxideLabs/gitoxide/commit/0887e2e0b7ebdcad30606a2633794ac8ff586091))
    - More examples using fully spelled out object names as fetch destination ([`095a099`](https://github.com/GitoxideLabs/gitoxide/commit/095a09918dc080ba7794c6ff13db0ef0ead20d0d))
    - Get more clarity about `git ls-remote` and `git fetch` ([`1b15fe8`](https://github.com/GitoxideLabs/gitoxide/commit/1b15fe80817d600f39090848c7d144ff94ac398c))
    - A tiny sketch of a possible matching API ([`39d5ff3`](https://github.com/GitoxideLabs/gitoxide/commit/39d5ff39ac58ec2abf2b55ee69df9905a4f303c2))
    - Assure ref-specs handle equality, ordering and hashing according to their instruction ([`b4bf7d0`](https://github.com/GitoxideLabs/gitoxide/commit/b4bf7d015a5d0d48bf7d0509d2fd930a1cb6f398))
    - Cleanup crate structure ([`f0163c9`](https://github.com/GitoxideLabs/gitoxide/commit/f0163c99bccfb7d6719217a8fa773667cabe95fd))
    - Don't expose mode() as it's kind of messy and should be left as implementation detail ([`6278966`](https://github.com/GitoxideLabs/gitoxide/commit/627896655ce04e1a306c5bf3970ebd6e73bb1a5d))
    - Improve docs ([`c695a7e`](https://github.com/GitoxideLabs/gitoxide/commit/c695a7e9716262d885c3ccfde68eb2077650b8ce))
    ...
    - Add fuzz target ([`62d721a`](https://github.com/GitoxideLabs/gitoxide/commit/62d721a5a7260adb408415810899bcf11d524d0c))
    - More push-spec restrictions ([`bb992ac`](https://github.com/GitoxideLabs/gitoxide/commit/bb992acc13fc2a63ec5098e9fa8954909ef486ca))
    - More detailed tests of what's allowed and where ([`57a6e69`](https://github.com/GitoxideLabs/gitoxide/commit/57a6e695697744459149dd6400c54b9c4c88a365))
    - Disallow excludes in push mode ([`9c280b2`](https://github.com/GitoxideLabs/gitoxide/commit/9c280b2de59773c6d13134e3257cf1da5731e35d))
    - Don't allow object hashes in excludes ([`b889953`](https://github.com/GitoxideLabs/gitoxide/commit/b8899532b461ebcdc0ecd33e54a8721e69136c22))
    - Negative must not be empty ([`79e0eaf`](https://github.com/GitoxideLabs/gitoxide/commit/79e0eaf4c754da47731f8c5ed3635339586b3d00))
    - Support for `@` shortcut. ([`32d98e9`](https://github.com/GitoxideLabs/gitoxide/commit/32d98e9c5db402bbfc04394218c0de30bfa64808))
    - And the entire test-suite passes ([`3fa52f8`](https://github.com/GitoxideLabs/gitoxide/commit/3fa52f8ffd04721e1367706318542cf6d4e71f3b))
    - Handle ref-name validation mostly correctly ([`d7c2789`](https://github.com/GitoxideLabs/gitoxide/commit/d7c27899c76092bdc8e86f2784aaf67666f117dd))
    - Refactor ([`e8c072e`](https://github.com/GitoxideLabs/gitoxide/commit/e8c072e99e845ed1b4a0cc0a0ec7146c53561dcd))
    - Tests causing all instrucitons ([`c23a21d`](https://github.com/GitoxideLabs/gitoxide/commit/c23a21d3e50e62d29bef4e638049b0398d3fb20e))
    - Tests for handling exclusions ([`c4499ce`](https://github.com/GitoxideLabs/gitoxide/commit/c4499ce13aa9e71c7b0024ad8658bdbcbccf5c14))
    - Better handling of special cases ([`c99f575`](https://github.com/GitoxideLabs/gitoxide/commit/c99f5750967a835afd9a99211b3520b441ae1881))
    - Basic validation and detection of patterns ([`e4227d6`](https://github.com/GitoxideLabs/gitoxide/commit/e4227d6ddd4cd021245bf6f352a0798457c37aae))
    - Handle colon and empty on the right side ([`7afebb7`](https://github.com/GitoxideLabs/gitoxide/commit/7afebb778b93611d924843c95acfd6b36f284fb2))
    - Support for deletion ([`966a9e9`](https://github.com/GitoxideLabs/gitoxide/commit/966a9e93b3afdcdc15af95c9fa3037d71af6e0ee))
    - Add include directive ([`701d46f`](https://github.com/GitoxideLabs/gitoxide/commit/701d46f020db5c5f86a0184ff345f30d077be8ed))
    - First successful test for returning a refspec. ([`6e5bd5c`](https://github.com/GitoxideLabs/gitoxide/commit/6e5bd5c152403d76ba1cf3da2b984689cb6fe8c5))
    - Sort out how expectations can be expressed in test suite ([`3f264af`](https://github.com/GitoxideLabs/gitoxide/commit/3f264afda02235dbcdf712d957e37c71ce749f01))
    - Refactor ([`6713793`](https://github.com/GitoxideLabs/gitoxide/commit/6713793dca4054a7f8717e70c8e9e4b7e625e9b4))
    - Sketch all possible instructions of fetch and push refspecs ([`0ba1b73`](https://github.com/GitoxideLabs/gitoxide/commit/0ba1b73bf988357f4b27753b87432618edec697a))
    - Run the baseline test and gather some information ([`5e4ee9b`](https://github.com/GitoxideLabs/gitoxide/commit/5e4ee9ba422cac9eef2b558746f3a3aa4b67a5e4))
    - First few bits of error handling in parser ([`9c5fed2`](https://github.com/GitoxideLabs/gitoxide/commit/9c5fed2e2a6ea388acde73be32f8b7f8687c415b))
    - Frame for basic parsing ([`b9a4bdc`](https://github.com/GitoxideLabs/gitoxide/commit/b9a4bdca41c074364b7bc26523784c35ac3196ce))
    - Sketch data structure that should do the trick ([`5c823dc`](https://github.com/GitoxideLabs/gitoxide/commit/5c823dcbfd3aca0a8846300629e01aed8d7b7e66))
    - All baseline test cases from git's test-suite ([`362bd46`](https://github.com/GitoxideLabs/gitoxide/commit/362bd4651751960b3062fd1c65d58b986b46cc97))
    - Prepare git-refspec changelog prior to release ([`3383408`](https://github.com/GitoxideLabs/gitoxide/commit/3383408ce22ca9c7502ad2d1fab51cf12dc5ee72))
    - Empty `git-refspec` crate for name reservation prior to implementation ([`871a3c0`](https://github.com/GitoxideLabs/gitoxide/commit/871a3c054d4fe6c1e92b6f2e260b19463404509f))
 ...
 * **[#571](https://github.com/GitoxideLabs/gitoxide/issues/571)**
    - Refactor ([`ef7467c`](https://github.com/GitoxideLabs/gitoxide/commit/ef7467cd61762dc4206fa82e66adc287ba2f7f52))
    - Assure sub-branches can be matched correctly ([`c9383c6`](https://github.com/GitoxideLabs/gitoxide/commit/c9383c693e0b3c506c9b1c42f339f40c1145f998))
 ...
 * **Uncategorized**
    ...
    - Rename `git-refspec` to `gix-refspec` ([`3c56012`](https://github.com/GitoxideLabs/gitoxide/commit/3c56012d7ba0e82ca566c0de9ad9dc2966f3a34f))
    ...
    - Release git-refspec v0.7.2, git-repository v0.34.0 ([`1210c19`](https://github.com/GitoxideLabs/gitoxide/commit/1210c1926851495df5d6fd3f6906602a7e423548))
    ...
    - Merge remote-tracking branch 'origin/main' ([`f5fbcfb`](https://github.com/GitoxideLabs/gitoxide/commit/f5fbcfbcf281429d56c46f815ca86da848410083))
    - Fixes build for parsing fuzz harness ([`d342922`](https://github.com/GitoxideLabs/gitoxide/commit/d34292294a0c41991aebd5af46e7bd7e3ad7324d))
    ...
    - Merge branch 'main' into gix-clone ([`91bf67a`](https://github.com/GitoxideLabs/gitoxide/commit/91bf67af9751d1e6beb78fb77b40f05352b98215))
    - Merge branch 'fix-571' ([`2514334`](https://github.com/GitoxideLabs/gitoxide/commit/2514334c17f543e3e18ac43261990ad412b7c7ae))
    ...
    - Remove lifetime of `match_group::Fix`, keeping `RefSpec` instances instead ([`2a0a87a`](https://github.com/GitoxideLabs/gitoxide/commit/2a0a87a04e7b4d6ed3be3d8adc89917576727686))
    - Another test to validate components must not be empty ([`b2c9af1`](https://github.com/GitoxideLabs/gitoxide/commit/b2c9af1cf7eedfb618c47d0598cfcef636e793ff))
    ...
    - `RefSpecRef::prefix()` to return the two-component prefix of a refspec's source. #(450) ([`6df179b`](https://github.com/GitoxideLabs/gitoxide/commit/6df179b5cf831402444cc78429a57f835358376e))
    ...
    - Thanks clippy ([`74a5f22`](https://github.com/GitoxideLabs/gitoxide/commit/74a5f2262154c5cb5434c1ef2854c4ec3d839f89))
    - Thanks clippy ([`016cd1f`](https://github.com/GitoxideLabs/gitoxide/commit/016cd1f70a536ac95eaa8b80958110caa096d875))
    - Thanks clippy ([`b8ac13e`](https://github.com/GitoxideLabs/gitoxide/commit/b8ac13e5074fa08111fcef1092432ed3a2326c6e))
    - Thanks clippy ([`73b405f`](https://github.com/GitoxideLabs/gitoxide/commit/73b405fe70cf7d53e5e011cf69ea654f4bd96dd2))
    ...
    - Thanks clippy ([`b9e1cdb`](https://github.com/GitoxideLabs/gitoxide/commit/b9e1cdbf19045816387d922abd9c886419ff6bf2))
    ...
    - Thanks clippy ([`6c963b0`](https://github.com/GitoxideLabs/gitoxide/commit/6c963b022e48854001353f8909c3e8314c2e5861))
    - Thanks clippy ([`b62ee56`](https://github.com/GitoxideLabs/gitoxide/commit/b62ee56b5bf468b9673b01034ec284faf1a7c7c2))
    - Release git-refspec v0.0.0 ([`d406689`](https://github.com/GitoxideLabs/gitoxide/commit/d406689f01c8fa7cc81b52d6500a44303e719ec2))
</details>
