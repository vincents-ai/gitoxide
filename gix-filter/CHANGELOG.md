 ...
 * **Uncategorized**
    ...
    - Merge pull request #2495 from cruessler/add-sha-256-to-gix-filter ([`e88240b`](https://github.com/GitoxideLabs/gitoxide/commit/e88240b6b37c078a3f9c81020eed0a949185b585))
    - Use `GIX_TEST_FIXTURE_HASH` for `gix-filter` ([`e9d4514`](https://github.com/GitoxideLabs/gitoxide/commit/e9d45142440e7a8e1fe2b6de200df6f27c74dd60))
 ...
 * **Uncategorized**
    ...
    - Thanks clippy ([`70f17ec`](https://github.com/GitoxideLabs/gitoxide/commit/70f17ecb588eddbe7b08a7a28b9d48293c7524b0))
    - Use quoted absolute path for `cat` on Windows in filter tests ([`e3f81ce`](https://github.com/GitoxideLabs/gitoxide/commit/e3f81ce9c9fffc98c0dfbd969a13a259ee435eaa))
    - Remove unnecessary `pub(crate)` on a test helper ([`85fd3b1`](https://github.com/GitoxideLabs/gitoxide/commit/85fd3b125b1b61b835b335a930e82f1aad19a1d0))
 ...
 * **Uncategorized**
    ...
    - Implement on-demand thread for non-blocking piped data processing ([`a457393`](https://github.com/GitoxideLabs/gitoxide/commit/a45739306a66e9777cf07cfed44c168b7e97c111))
